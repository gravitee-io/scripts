...
install()
{
	case "$os" in
		aws|amzn)
			curl -L https://raw.githubusercontent.com/gravitee-io/scripts/master/apim/4.x/amzn/install_amzn_${dist}.sh | bash
		;;
		ol|centos|rhel)
			curl -L https://raw.githubusercontent.com/gravitee-io/scripts/master/apim/4.x/redhat/install_redhat.sh | bash
		;;
    sles)
      curl -L https://raw.githubusercontent.com/gravitee-io/scripts/master/apim/4.x/sles/install_sles.sh | bash
    ;;
		*)
