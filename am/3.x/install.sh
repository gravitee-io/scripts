...
install()
{
	case "$os" in
		aws|amzn)
			curl -L https://raw.githubusercontent.com/gravitee-io/scripts/master/am/3.x/amzn/install_amzn_${dist}.sh | bash
		;;
		ol|centos|rhel)
			curl -L https://raw.githubusercontent.com/gravitee-io/scripts/master/am/3.x/redhat/install_redhat.sh | bash
		;;
    sles)
      curl -L https://raw.githubusercontent.com/gravitee-io/scripts/master/am/3.x/sles/install_sles.sh | bash
    ;;
		*)  
